...
const DisplayMasterFilter = () => {
    const masterItems = [
        ...
        { id: 3, name: 'Accounting Info Master', 
            subItems: [
                { id: 4, name: 'Account Group', path: '/display/displayGroupFilter' },
                { id: 5, name: 'Account Ledger', path: '/display/createLedger' }
            ] 
        },
...
export default DisplayMasterFilter;
