...
import { getSpecificCostCategory } from '../services/MasterService';

const CostCategoryDisplay = () => {
      ...
      <div className='flex'>
        ...
        <form action="" className='border border-slate-500 w-[36%] h-[10vh] absolute left-[54%]'>
          <div className='text-sm p-3 flex'>
            ...
            <span>:</span>
            <input type="text" id='costCategoryName' name='costCategoryName' value={costCategory.costCategoryName}  ref={input => inputRefs.current[0] = input} className='w-[300px] ml-2 h-5 pl-1 font-medium text-sm capitalize focus:bg-yellow-200 focus:outline-none focus:border-blue-500 focus:border' autoComplete='off' readOnly />
          </div>
        </form>
        <RightSideButton />
      </div>
