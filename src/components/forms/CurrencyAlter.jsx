                ...
                <div>
                  ...
                  <div>
                    ...
                    <div>
                      ...
                      <span className='font-medium'>₹</span>
                      <input type="text" id='rateForReceiptInvoice' name='rateForReceiptInvoice' value={currency.rateForReceiptInvoice} onChange={handleInputChange} ref={(input) => (inputRefs.current[12] = input)} onKeyDown={e => handleKeyDown(e, 12)} onBlur={(e) => {numberFormat(e)}} className='w-[50px] h-5 font-medium text-right pr-1 text-sm focus:bg-yellow-200 focus:border focus:border-blue-500 focus:outline-none border-transparent' autoComplete='off'  />
                    </div>
                  </div>
                </div>
              </div>
