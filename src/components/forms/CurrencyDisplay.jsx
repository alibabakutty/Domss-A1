      ...
      <div>
        <form>
          <div className='ml-2 flex leading-4 mt-3'>
            ...
            <span>:</span>
            <input type="text" id='forexCurrencySymbol' name='forexCurrencySymbol' value={currency.forexCurrencySymbol}  ref={(input) => (inputRefs.current[0] = input)} onKeyDown={e => handleKeyDown(e, 0)} className='w-[60px] ml-2 h-5 font-medium uppercase pl-1 text-sm focus:bg-yellow-200 focus:border focus:border-blue-500 focus:outline-none border-transparent' autoComplete='off' readOnly />
          </div>
          <div className='ml-2 flex leading-4'>
            <label htmlFor="forexCurrencyName" className='text-sm w-[15%]'>Forex Currency Name</label>
            <span>:</span>
            <input type="text" id='forexCurrencyName' name='forexCurrencyName' value={currency.forexCurrencyName}  ref={(input) => (inputRefs.current[1] = input)} onKeyDown={e => handleKeyDown(e, 1)} className='w-[200px] ml-2 h-5 pl-1 font-medium text-sm uppercase focus:bg-yellow-200 focus:outline-none border-transparent focus:border-blue-500 focus:border' autoComplete='off' readOnly />
          </div>
          <div className='ml-2 flex leading-4'>
            <label htmlFor="country" className='text-sm w-[15%]'>Country</label>
            <span>:</span>
            <input type="text" id='country' name='country' value={currency.country}  ref={(input) => (inputRefs.current[2] = input)} onKeyDown={e => handleKeyDown(e, 2)} className='w-[200px] ml-2 h-5 font-medium pl-1 text-sm uppercase focus:bg-yellow-200 focus:border focus:border-blue-500 focus:outline-none border-transparent' autoComplete='off' readOnly />
          </div>
                ...
                <div>
                  ...
                  <div className='flex'>
                    <div>
                      ...
                      <input type="text" id='voucherDate' name='voucherDate' value={currency.voucherDate}  ref={(input) => (inputRefs.current[3] = input)} onKeyDown={e => handleKeyDown(e, 3)} className='w-[100px] h-5 font-medium pl-2 text-sm focus:bg-yellow-200 focus:border focus:border-blue-500 focus:outline-none border-transparent' autoComplete='off' readOnly />
                    </div>
                  </div>
                </div>
              </div>
              <div className='w-[115px] h-[75.6vh] border border-r-slate-500'>
                ...
                <div className='flex justify-center'>
                    <div>
                      ...
                      <input type="text" id='currencySymbol' name='currencySymbol' value={currency.currencySymbol}  ref={(input) => (inputRefs.current[4] = input)} onKeyDown={e => handleKeyDown(e, 4)} className='w-[40px] h-5 font-medium uppercase pl-1 text-sm focus:bg-yellow-200 focus:border focus:border-blue-500 focus:outline-none border-transparent' autoComplete='off' readOnly />
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div>
                  ...
                  <div className='flex justify-between'>
                    ...
                    <div>
                      ...
                      <input type="text" id='rateForSalesInvoice' name='rateForSalesInvoice' value={currency.rateForSalesInvoice}  ref={(input) => (inputRefs.current[6] = input)} onKeyDown={e => handleKeyDown(e, 6)} className='w-[50px] h-5 font-medium text-right pr-1 text-sm focus:bg-yellow-200 focus:border focus:border-blue-500 focus:outline-none border-transparent' autoComplete='off' readOnly />
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div>
                  ...
                  <div>
                    ...
                    <div>
                      ...
                      <span className='font-medium'>₹</span>
                      <input type="text" id='rateForPaymentInvoice' name='rateForPaymentInvoice' value={currency.rateForPaymentInvoice}  ref={(input) => (inputRefs.current[10] = input)} onKeyDown={e => handleKeyDown(e, 10)} className='w-[50px] h-5 font-medium text-right pr-1 text-sm focus:bg-yellow-200 focus:border focus:border-blue-500 focus:outline-none border-transparent' autoComplete='off' readOnly />
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div>
                  ...
                  <div>
                    ...
                    <div>
                      ...
                      <span className='font-medium'>₹</span>
                      <input type="text" id='rateForReceiptInvoice' name='rateForReceiptInvoice' value={currency.rateForReceiptInvoice}  ref={(input) => (inputRefs.current[12] = input)} onKeyDown={e => handleKeyDown(e, 12)} className='w-[50px] h-5 font-medium text-right pr-1 text-sm focus:bg-yellow-200 focus:border focus:border-blue-500 focus:outline-none border-transparent' autoComplete='off' readOnly />
                    </div>
                  </div>
                </div>
              </div>
