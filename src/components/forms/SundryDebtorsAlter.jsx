...
const SundryDebtorsAlter = () => {
    ...
    const loadCustomers = async () => {
      try {
        ...
        if (Array.isArray(sundryDebtorForexDetails) && sundryDebtorForexDetails.length > 0){
          ...
          console.log(fetchedForexSubForm);
  ...
  const calculateTotals = () => {
    ...
    setSundryDebtor((prevState) => {
      ...
      console.log('Calculated Totals', {totalForexAmount: formattedTotalForexAmount, totalAmount: formattedTotalAmount, });
  ...
  const prepareDataForBackend = (sundryDebtor) => {
    return {
      ...
      sundryDebtorForexDetails: Array.isArray(sundryDebtor.forexSubForm) ? sundryDebtor.forexSubForm
