...
const handlePeriodicityClick = (item) => {
  setVoucher((prevVoucher) => ({
    ...prevVoucher,
    restartNumberingPeriodicity: item
  }));
  setPeriodicityFocused(false);
};
            ...
            <div className='w-full h-20'>
              <div className='float-left w-[50%] ml-16'>
                <div className='ml-2 flex leading-6'>
                  <label htmlFor="voucherTypeName" className='w-[30%] text-sm font-medium'>Voucher Type Name</label>
                  <span>:</span>
                  <input type="text" id='voucherTypeName' name='voucherTypeName' value={voucher.voucherTypeName} ref={(input) => (inputRefs.current[0] = input)} onChange={handleInputChange} onKeyDown={(e) => handleKeyDown(e,0)} onFocus={() => pulseCursor(inputRefs.current[0])} className='w-[250px] ml-2 h-5 font-medium capitalize pl-1 text-sm focus:bg-yellow-200 focus:border focus:border-blue-500 focus:outline-none' autoComplete='off' />
                </div>
                <div className='ml-2 flex leading-6'>
                  <label htmlFor="voucherType" className='w-[30%] text-sm font-medium'>Under</label>
                  <span>:</span>
                  <input type="text" id='voucherType' name='voucherType' value={voucher.voucherType} ref={(input) => (inputRefs.current[1] = input)} onChange={handleInputChange} onKeyDown={(e) => handleKeyDown(e,1)} onFocus={() => pulseCursor(setVoucherTypeFocused(true))} onBlur={() => setVoucherTypeFocused(false)} className='w-[250px] ml-2 h-5 font-medium capitalize pl-1 text-sm focus:bg-yellow-200 focus:border focus:border-blue-500 focus:outline-none' autoComplete='off' />
                  {voucherTypeFocused && voucherTypeSuggestions.length > 0 &&(
                    <div className='w-[15%] h-[85.5vh] border border-gray-500 bg-[#CAF4FF]' style={{position: 'absolute', top: '42px', left: '1024px'}}>
                      <div className='text-left bg-[#003285] text-[13.5px] text-white pl-2'>
                        <p>List of Voucher Types</p>
                      </div>
                      <ul className='suggestions w-full h-[20vh] text-left text-sm mt-2' ref={optionsRef}>
                        {voucherTypeSuggestions.map((item,index) => (
                          <li key={index} tabIndex={0} className={`pl-2 ${highlightedSuggestionPeriodicity === index ? 'bg-yellow-200' : ''}`} onClick={() => handleSuggestionClick(item)}>
                            {item.label}
                          </li>
                        ))}
                      </ul>
              ...
              <div className='float-right w-[40%] absolute left-[600px] top-[50px]'>
                <div className='ml-2 flex leading-6'>
                  <label htmlFor="startingNumber" className='w-[40%] text-sm font-medium'>Starting Number</label>
                  <span>:</span>
                  <input type="text" id='startingNumber' name='startingNumber' value={voucher.startingNumber} ref={(input) => (inputRefs.current[2] = input)} onChange={handleInputChange} onKeyDown={(e) => handleKeyDown(e,2)} onFocus={() => pulseCursor(inputRefs.current[2])} className='w-[80px] ml-2 h-5 font-medium pl-1 text-sm focus:bg-yellow-200 focus:border focus:border-blue-500 focus:outline-none' autoComplete='off' />
                </div>
                <div className='ml-2 flex leading-6'>
                  <label htmlFor="widthOfNumericalPart" className='w-[40%] text-sm font-medium'>Width of Numerical Part</label>
                  <span>:</span>
                  <input type="text" id='widthOfNumericalPart' name='widthOfNumericalPart' value={voucher.widthOfNumericalPart} ref={(input) => (inputRefs.current[3] = input)} onKeyDown={(e) => handleKeyDown(e,3)} onChange={handleInputChange} onFocus={() => pulseCursor(inputRefs.current[3])} className='w-[80px] ml-2 h-5 font-medium pl-1 text-sm focus:bg-yellow-200 focus:border focus:border-blue-500 focus:outline-none' autoComplete='off' />
                </div>
                <div className='flex ml-2 leading-6'>
                  <label htmlFor="prefillWithZero" className='w-[40%] text-sm font-medium'>Prefill with Zero</label>
                  <span>:</span>
                  <input type="text" id='prefillWithZero' name='prefillWithZero' value={voucher.prefillWithZero} ref={(input) => (inputRefs.current[4] = input)} onChange={handleInputChange} onKeyDown={(e) => handleKeyDown(e,4)} onFocus={() => pulseCursor(inputRefs.current[4])} className='w-[80px] ml-2 h-5 capitalize font-medium pl-1 text-sm focus:bg-yellow-200 focus:border focus:border-blue-500 focus:outline-none' autoComplete='off' />
                </div>
              </div>
            </div>
              ...
              <div className='w-[420px] border border-r-slate-400'>
                ...
                <div className='flex justify-evenly'>
                  <div>
                    ...
                    <input type="text" id='restartNumberingApplicationForm' name='restartNumberingApplicationForm' value={voucher.restartNumberingApplicationForm} ref={(input) => (inputRefs.current[5] = input)} onChange={handleDateInputChange} onKeyDown={(e) => handleKeyDown(e,5)} onFocus={() => pulseCursor(inputRefs.current[5])} className='w-[100px] ml-2 h-5 capitalize font-medium pl-1 text-sm focus:bg-yellow-200 focus:border focus:border-blue-500 focus:outline-none' autoComplete='off' />
                  </div>
                  <div>
                    <label htmlFor="restartNumberingStartingNumber"></label>
                    <input type="text" id='restartNumberingStartingNumber' name='restartNumberingStartingNumber' value={voucher.restartNumberingStartingNumber} ref={(input) => (inputRefs.current[6] = input)} onChange={handleInputChange} onKeyDown={(e) => handleKeyDown(e,6)} onFocus={() => pulseCursor(inputRefs.current[6])} className='w-[100px] ml-2 h-5 capitalize font-medium pl-1 text-sm focus:bg-yellow-200 focus:border focus:border-blue-500 focus:outline-none' autoComplete='off' />
                  </div>
                  <div>
                    <label htmlFor="restartNumberingPeriodicity"></label>
                    <input type="text" id='restartNumberingPeriodicity' name='restartNumberingPeriodicity' value={voucher.restartNumberingPeriodicity} ref={(input) => (inputRefs.current[7] = input)} onChange={handleInputChange} onKeyDown={(e) => handleKeyDown(e,7)} onFocus={() => {pulseCursor(inputRefs.current[7]); setPeriodicityFocused(true)}} onBlur={() => setPeriodicityFocused(false)} className='w-[100px] ml-2 h-5 capitalize font-medium pl-1 text-sm focus:bg-yellow-200 focus:border focus:border-blue-500 focus:outline-none' autoComplete='off' />
                    {periodicityFocused && periodicitySuggestions.length > 0 && (
                      <div ref={periodicityRef} className='bg-white border border-gray-300 absolute mt-1 w-[250px] max-h-48 overflow-y-auto'>
                        {periodicitySuggestions.map((item,index) => (
                          <div key={index} onClick={() => handlePeriodicityClick(item)} className={`p-2 cursor-pointer hover:bg-blue-100 ${index === highlightedSuggestionPeriodicity ? 'bg-blue-200' : ''}`}>
                            {item}
                          </div>
                        ))}
                      </div>
              ...
              <div className='w-[420px] border border-r-slate-400'>
                ...
                <div className='flex justify-evenly'>
                  <div>
                    ...
                    <input type="text" id='prefixDetailsApplicationForm' name='prefixDetailsApplicationForm' value={voucher.prefixDetailsApplicationForm} ref={(input) => (inputRefs.current[8] = input)} onChange={handleDateInputChange} onKeyDown={(e) => handleKeyDown(e,8)} onFocus={() => pulseCursor(inputRefs.current[8])} className='w-[100px] ml-2 h-5 capitalize font-medium pl-1 text-sm focus:bg-yellow-200 focus:border focus:border-blue-500 focus:outline-none' autoComplete='off' />
                  </div>
                  <div>
                    <label htmlFor="prefixDetailsParticulars"></label>
                    <input type="text" id='prefixDetailsParticulars' name='prefixDetailsParticulars' value={voucher.prefixDetailsParticulars} ref={(input) => (inputRefs.current[9] = input)} onChange={handleInputChange} onKeyDown={(e) => handleKeyDown(e,9)} onFocus={() => pulseCursor(inputRefs.current[9])} className='w-[100px] ml-2 h-5 capitalize font-medium pl-1 text-sm focus:bg-yellow-200 focus:border focus:border-blue-500 focus:outline-none' autoComplete='off' />
                  </div>
                </div>
              </div>
              <div className='w-[420px] border border-r-slate-400'>
                ...
                <div className='flex justify-evenly'>
                  <div>
                    ...
                    <input type="text" id='suffixDetailsApplicationForm' name='suffixDetailsApplicationForm' value={voucher.suffixDetailsApplicationForm} ref={(input) => (inputRefs.current[10] = input)} onChange={handleDateInputChange} onKeyDown={(e) => handleKeyDown(e,10)} onFocus={() => pulseCursor(inputRefs.current[10])} className='w-[100px] ml-2 h-5 capitalize font-medium pl-1 text-sm focus:bg-yellow-200 focus:border focus:border-blue-500 focus:outline-none' autoComplete='off' />
                  </div>
                  <div>
                    <label htmlFor="suffixDetailsParticulars"></label>
                    <input type="text" id='suffixDetailsParticulars' name='suffixDetailsParticulars' value={voucher.suffixDetailsParticulars} ref={(input) => (inputRefs.current[11] = input)} onChange={handleInputChange} onKeyDown={(e) => {handleKeyDown(e,11)}} onFocus={() => pulseCursor(inputRefs.current[11])} className='w-[100px] ml-2 h-5 capitalize font-medium pl-1 text-sm focus:bg-yellow-200 focus:border focus:border-blue-500 focus:outline-none' autoComplete='off' />
                  </div>
                </div>
              </div>
